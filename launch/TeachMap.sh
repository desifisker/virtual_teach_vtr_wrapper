...
ros2 run vtr_virtualteach generate_global_map "${VTRROOT}/data/<PROJECT_NAME>/point_cloud.pcd" "${VTRROOT}/data/<PROJECT_NAME>/nerf_gazebo_transformations.csv" "${VTRROOT}/data/<PROJECT_NAME>/graph"
EOF
)
